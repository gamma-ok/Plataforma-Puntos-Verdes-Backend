...
public class EntregaValidadaDTO {
    ...
    public String getPuntoVerdeDireccion() { return puntoVerdeDireccion; }
    public void setPuntoVerdeDireccion(String puntoVerdeDireccion) { this.puntoVerdeDireccion = puntoVerdeDireccion; }
    public String getRolUsuarioEntrega() { return rolUsuarioEntrega; }
    public void setRolUsuarioEntrega(String rolUsuarioEntrega) { this.rolUsuarioEntrega = rolUsuarioEntrega; }
